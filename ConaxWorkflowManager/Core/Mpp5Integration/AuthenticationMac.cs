...
namespace MPS.MPP.Auxiliary.ConaxWorkflowManager.Core.Mpp5Integration
{
    class AuthenticationMac
    {
        ...
        public AuthenticationMac(string username, Guid client, long timeStamp, string nonce, string method, string resource, ICryptoProvider cryptoProvider, byte[] authenticationKey)
            : this(username, client, timeStamp, nonce, method, resource, null)
        {
